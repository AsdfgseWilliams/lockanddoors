      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button variant="primary">
            {hero.textoBoton1 && hero.enlaceBoton1 && <Link href={hero.enlaceBoton1}>{hero.textoBoton1}</Link>}
          </Button>

          <Button variant="secondary">
          {hero.textoBoton2 && hero.enlaceBoton2 && <Link href={hero.enlaceBoton2}>{hero.textoBoton2}</Link>}
          </Button>
        </div>
      </div>
    </section>
